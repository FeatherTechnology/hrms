<div class="row gutters">
                ...
                <div class="card" id="counts_div">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <h1 class="general_feedback m-2 font-weight-bold" style="font-size:70px">0</h1>

                            <span id="general_feedbackViewAll" class="text-primary" style="cursor:pointer;"> View All >>>></span>
                ...
                <div class="card" id="counts_div">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <!-- <h6 class="average_rating m-2 font-weight-bold" style="font-size:70px">0</h6> -->
    ...
    <!-- Attendance Overview -->
    <div class="col-lg-12 col-md-12 mt-3" id="general_feedback_section" style="display: none;">
        <div class="card">
            ...
            <div class="card-body">
                <div class="feedback_list">
                    <div id="general_feedback_table_div" class="table-divs" style="overflow-x: auto;">
    ...
    <div class="col-lg-12 col-md-12 mt-3" id="feedback_section" style="display: none;">
        <div class="card">
                    ...
                    <div id="feedback_table_div" class="table-divs" style="overflow-x: auto;">
                        <table id="feedback_table" class="table custom-table">
                            <thead>
                                ...
                                <th>Start Date</th>
                                <th>End Rate Date</th>
                                <th>Total Response / No of Staff</th>
                            </thead>
                            <tbody></tbody>
                        </table>
                    </div>
    ...
    <div class="col-lg-12 col-md-12 mt-3" id="rating_section" style="display: none;">
        <div class="card">
    ...
    <div class="col-lg-12 col-md-12 mt-3" id="poll_section" style="display: none;">
        <div class="card">
