                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <select type="text" class="form-control" id="company_name" name="company_name" tabindex="1">
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="pincode" name="pincode" maxlength="6" pattern="\d{6}" onKeyPress="if(this.value.length==6) return false;" placeholder="Enter Pincode" tabindex="8">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            <label for="location">Location</label><span class="text-danger">*</span>
                                            <input type="text" class="form-control" id="location" name="location" placeholder="Enter Location" tabindex="9">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group" style="gap:12px">
                                                ...
                                                <input type="number" class="form-control" id="landline" name="landline" onKeyPress="if(this.value.length==8) return false;" placeholder="Enter Landline Number" tabindex="14">
                                            </div>
                                        </div>
                                    </div>
                                </div>
