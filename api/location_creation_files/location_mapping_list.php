...
$qry = $pdo->query("SELECT lam.id, bc.branch_name, bcs.branch_name AS assigned_branch_name, lam.from_date, lam.to_date, lam.no_of_days, lam.lattitude_longitude , lam.staff_profile_id
