...
{
    $query = $pdo->query("SELECT count(cs.cus_profile_id) as cus_profile_id FROM customer_status cs LEFT JOIN loan_entry_loan_calculation lelc ON cs.cus_profile_id = lelc.cus_profile_id where lelc.due_type = 'EMI'");
