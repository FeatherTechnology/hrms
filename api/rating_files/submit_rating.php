...
if ($rating_titles_id != '') {
    ...
    `rating_title`='$rating_title', `rating_description`='$rating_description',  `update_login_id`='$user_id', `updated_date`=now() WHERE `id`='$rating_titles_id'");
    ...
    $qry = $pdo->query("INSERT INTO `rating_titles`(`company_id`,`start_date_time`, `end_date_time`, `rating_title`, `rating_description`, `rating_status`, `insert_login_id`, `created_date`) VALUES ('$rating_company_name','$rating_start_date', '$rating_end_date', '$rating_title', '$rating_description', '0', '$user_id', now())");
